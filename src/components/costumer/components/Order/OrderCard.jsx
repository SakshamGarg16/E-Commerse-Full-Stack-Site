...
const OrderCard = () => {
  ...
  return (
    <div onClick={()=>navigate(`/account/order/${3}`)} className='p-5 border shadow-md hover:shadow-2xl'>
        <Grid container spacing={2} sx={{justifyContent:'space-between'}}>
            ...
            <Grid item xs={4}>
                {true&& <div>
                    ...
                    <span>Delivered on December 03,2024</span>
