...
import MainCardCarosel from "../HomeCarosel/MainCardCarosel";
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10 ">
          ...
          {/* Product info */}
          <div className="border lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <p className="opacity-50 text-sm">87557 Ratings</p>
              <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-400 ">5677 Reviews</p>
              </div>
              </div>
      ...
      {/* Ratings and Reviews */}
                ...
                <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                        ...
                        <div className="flex items-center space-x-5">
                            <Rating readOnly precision={0.5} value={3.4}/>
                        ...
                        <Box className="mt-5 space-y-4">
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant="determinate" value={15} className="bg-yellow-500"/>
                                </Grid>
                            </Grid>
                            <Grid container alignItems="center" gap={2}>
                                <Grid item xs={2}>
        ...
        <section className="pt-10 ">
            ...
            <div className="flex flex-wrap space-y-5">
                {mens_kurta.map((item)=><MainCard product= {item}/>)}
            </div>
        </section>
      </div>
    </div>
